...
public class LinearEquation {
    ...
    public static void theSystemfirstDegreeEquation() {
        ...
        if (D == Dx && Dx == Dy && Dx == 0)
            ...
            // x = Dx / D
            // y = Dy / D
            JOptionPane.showMessageDialog(null, " - Hệ có nghiệm x = " + (Dx / D) + " y = " + (Dy / D),
                    expression, JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public static void seconDegreeEquation() {
         ...
         * + Nếu b == 0 và c == 0 pt vô số nghiệm
         * + Nếu b != 0 thì pt có nghiệm -c / b
         */
        if (a == 0) {
            if (b == 0)
                if (c != 0)
            ...
            /*
             * Nếu a != 0 => delta = b^2 - 4ac
             * + delta < 0 -> pt vô nghiệm
             * + delta == 0 -> pt có nghiệm duy nhất x = -b/2a
             * + delta > 0 -> pt có 2 nghiệm phân biệt x1 = ( -b - sqrt(delta) ) / 2a
             * x2 = ( -b + sqrt(delta) ) / 2a
             */
            // caculate delta
            delta = b * b - 4 * a * c;
            if (delta < 0)
                ...
                // show result
                JOptionPane.showMessageDialog(null, " - PT có nghiệm duy nhất x = " + (-b / (2 / a)),
                        expression, JOptionPane.INFORMATION_MESSAGE);
            else {
                // caculate x1 and x2
                ...
                JOptionPane.showMessageDialog(null,
                        " - PT có 2 nghiệm phân biệt x1 = " + x1 + " x2 = " + x2,
                        expression, JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            /*
             * choose == 1 Giải phương trình bậc 1
             * choose == 2 Giải hệ phương trình bậc 1
             * choose == 3 Giải phương trình bậc 2
             * choose == 4 Thoát
             */
            switch (choose) {
                case 1:
